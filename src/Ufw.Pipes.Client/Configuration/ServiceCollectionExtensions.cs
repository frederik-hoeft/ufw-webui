...
using Ufw.Pipes.Client.Transport.Tcp;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddUfwClientServices(this IServiceCollection services, Action<UfwClientBuilder> configureClient)
    {
        ...
        services.AddSingleton<ITransportLayerService, TcpClientTransportService>();
        services.AddSingleton<ITcpClientStreamFactory, TcpClientStreamFactory>();
