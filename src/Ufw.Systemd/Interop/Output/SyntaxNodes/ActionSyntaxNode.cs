...
internal sealed class ActionSyntaxNode(string? name, RuleType ruleType, Direction direction)
    : SyntaxNodeBase<IUfwListCommandResultRowVisitor, FirewallAction>(name, new FirewallAction(ruleType, direction))
{
