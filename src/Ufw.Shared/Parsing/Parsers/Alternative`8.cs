...
public sealed class Alternative<TParser1, TParser2, TParser3, TParser4, TParser5, TParser6, TParser7, TParser8>(string? name = null)
    : Alternative(parsers: [TParser1.Instance, TParser2.Instance, TParser3.Instance, TParser4.Instance, TParser5.Instance, TParser6.Instance, TParser7.Instance, TParser8.Instance], name),
